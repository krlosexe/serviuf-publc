            ...
            success: function(respuesta) {
                if (respuesta.success == false) {
                    ...
                    if (auth) {
                        ...
                        if (respuesta.rol == 22) {
                            window.location.href = url + "/pacientes-referidos";
                        } else {
...
$("#send_usuario").click(function() {
    ...
    if (comprobar_img) {
        $('.tab_content_edit0').removeClass("active in");
        $('#edit_tab0').removeClass("active");
        $('.tab_content_edit1').removeClass("active in");
        $('#edit_tab1').removeClass("active");
        $('.tab_content_edit11').removeClass("active in");
        $('#tab11').removeClass("active");
        $('.tab_content_edit2').removeClass("active in");
        $('#tab2').removeClass("active");
        $('.tab_content_edit3').removeClass("active in");
        $('#tab3').removeClass("active");
        $('.tab_content_edit4').removeClass("active in");
        $('#tab4').removeClass("active");
        $('.tab_content_edit5').removeClass("active in");
        $('#tab5').removeClass("active");
        $('.tab_content_edit6').removeClass("active in");
        $('#tab6').removeClass("active");
        $('.tab_content80').removeClass("active in");
        $('#tab80').removeClass("active");

        $('.tab_content_edit0').addClass("active in show");
        $('#tab0').addClass("active");

    } else if (comprobar_reg) {

        $('.tab_content0').removeClass("active in");
        ...
        $('#tab5').removeClass("active");
        $('.tab_content6').removeClass("active in");
        $('#tab6').removeClass("active");
        $('.tab_content' + comprobar_reg_tab).addClass("active in show");
        $('#tab' + comprobar_reg_tab).addClass("active");
